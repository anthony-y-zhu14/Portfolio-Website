          ...
          {renderMessageUI && (
            <React.Fragment>
              ...
              <Grid Container spacing={1}>
                ...
                <Grid item xs={12}>
                  <TextField variant='outlined' label="Message" value={message} onChange={(e)=>setMessage(e.target.value)} multiline rows={5} InputProps={{classes: {root : classes.input}}}/>  
                </Grid>                  
                <Grid item xs={12}>
                  <br/>
                  <Button color='primary' disabled={ !message || !name || !email } variant='contained' onClick={handleSend}>Send</Button>  
                </Grid>
              </Grid> 
              </Zoom>                       
            </React.Fragment>
